...
SOURCE="$HLAX64_ROOT/examples/interop/semasm-vaa/find_last_byte/find_last_byte.hla64"
OUT_ASM="$VAA_ROOT/fixtures/ingest/hlax64_find_last_byte/candidate.asm"
TMP="$(mktemp).asm"
...
grep -q "global find_last_byte" "$TMP" || { echo "emit missing global find_last_byte" >&2; exit 1; }
