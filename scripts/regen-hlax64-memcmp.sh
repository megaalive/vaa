...
SOURCE="$HLAX64_ROOT/examples/interop/semasm-vaa/memcmp/memcmp.hla64"
OUT_ASM="$VAA_ROOT/fixtures/ingest/hlax64_memcmp/candidate.asm"
TMP="$(mktemp).asm"
...
grep -q "global memcmp" "$TMP" || { echo "emit missing global memcmp" >&2; exit 1; }
