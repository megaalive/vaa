...
SOURCE="$HLAX64_ROOT/examples/interop/semasm-vaa/find_first_byte/find_first_byte.hla64"
OUT_ASM="$VAA_ROOT/fixtures/ingest/hlax64_find_first_byte/candidate.asm"
TMP="$(mktemp).asm"
...
grep -q "global find_first_byte" "$TMP" || { echo "emit missing global find_first_byte" >&2; exit 1; }
