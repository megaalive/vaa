...
SOURCE="$HLAX64_ROOT/examples/interop/semasm-vaa/max_usize/max_usize.hla64"
OUT_ASM="$VAA_ROOT/fixtures/ingest/hlax64_max_usize/candidate.asm"
TMP="$(mktemp).asm"
...
grep -q "global max_usize" "$TMP" || { echo "emit missing global max_usize" >&2; exit 1; }
