...
Write-Host "== Gate 7n: SysV callee-saved worktree live repair fixtures =="
Invoke-Vaa repair verify fixtures/repair/hlax64-callee-saved-sysv-live-worktree/repair-packet.json
Invoke-Vaa patch evidence-verify fixtures/repair/hlax64-callee-saved-sysv-live-worktree/patch-evidence.json
