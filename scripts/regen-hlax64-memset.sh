...
SOURCE="$HLAX64_ROOT/examples/interop/semasm-vaa/memset/memset.hla64"
OUT_ASM="$VAA_ROOT/fixtures/ingest/hlax64_memset/candidate.asm"
TMP="$(mktemp).asm"
...
grep -q "global memset" "$TMP" || { echo "emit missing global memset" >&2; exit 1; }
