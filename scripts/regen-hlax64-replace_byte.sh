...
SOURCE="$HLAX64_ROOT/examples/interop/semasm-vaa/replace_byte/replace_byte.hla64"
OUT_ASM="$VAA_ROOT/fixtures/ingest/hlax64_replace_byte/candidate.asm"
TMP="$(mktemp).asm"
...
grep -q "global replace_byte" "$TMP" || { echo "emit missing global replace_byte" >&2; exit 1; }
