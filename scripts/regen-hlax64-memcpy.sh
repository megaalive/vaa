...
SOURCE="$HLAX64_ROOT/examples/interop/semasm-vaa/memcpy/memcpy.hla64"
OUT_ASM="$VAA_ROOT/fixtures/ingest/hlax64_memcpy/candidate.asm"
TMP="$(mktemp).asm"
...
grep -q "global memcpy" "$TMP" || { echo "emit missing global memcpy" >&2; exit 1; }
