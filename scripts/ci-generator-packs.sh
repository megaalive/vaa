...
vaa suite check-parity integrations/echoasm/suites/gate-scalar-i64-win64.vaa-suite.toml
...
echo "== Gate 7e: Win64 unsigned worktree live repair fixtures =="
...
echo "== Gate 7f: SysV signed worktree live repair fixtures =="
...
echo "== Gate 7g: Win64 max unsigned worktree live repair fixtures =="
...
echo "== Gate 7h: Win64 max signed worktree live repair fixtures =="
...
echo "== Gate 7i: SysV max signed worktree live repair fixtures =="
...
echo "== Gate 7n: SysV callee-saved worktree live repair fixtures =="
