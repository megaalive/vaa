...
| T14 | clipboard / path helper (Win) | hosted-only; build/import UX — **not** skill seal | `friction_logged` | 2026-07-27: `cwd`+`clip` modes; `GetCurrentDirectoryA` arg-swap AV fixed. [t14-clipboard-path.md](t14-clipboard-path.md) |
