...
use vaa::{
    EvidenceAggregator, EvidenceStatus, SemasmDoctor, SemasmVerify, TargetCapabilities,
    VerifyError, MATURITY, TASK_SCHEMA_VERSION, VAA_VERSION,
};
...
fn print_status() {
    ...
    println!("commands: version, status, validate, doctor, capabilities, verify");
